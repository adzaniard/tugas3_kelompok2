...
class plants {
    ...
    public function getAllPlants() {
        $query = $this->db->query("SELECT plants.id_tanaman plants.nama_tanaman, categories.nama_kategori, plants.deskripsi, plants.harga, plants.penjual FROM plants JOIN categories ON plants.id_kategori = categories.id_kategori");
    ...
    public function add($nama_tanaman, $id_kategori, $deskripsi, $harga, $penjual) {
        $query = $this->db->prepare("INSERT INTO plants (nama_tanaman, id_kategori, deskripsi, harga, penjual) VALUES (:nama_tanaman, :deskripsi, :harga, :penjual)");
        ...
        $query->bindParam(':penjual', $penjual, PDO::PARAM_INT);
